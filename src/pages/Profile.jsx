...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        setProfileUser(isOwnProfile ? user : null);
      }
    };
    fetchUser();
  ...
  useEffect(() => {
    if (displayUser && user && !isOwnProfile) {
      ...
      setIsFollowing(Array.isArray(following) && following.some(f => f._id?.toString() === displayUser._id || f.toString() === displayUser._id));
    }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 lg:border-none">
        <div className="p-4 lg:p-8 flex items-start space-x-4 lg:space-x-8">
          {/* Avatar */}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex space-x-8 mb-4">
              <div className="flex flex-col items-center lg:items-start">
                <span className="font-semibold dark:text-white">{userPosts?.length || 0}</span>
